...
rtkpin_glmm1 <-  lmer(Sediment_Change ~ Shoreline_End*Log_Presence*Pin_Location+(1|Transect_ID),
                     data = RTKpinschange_norefs)


summary(rtkpin_glmm1)
Anova(rtkpin_glmm1)
#use emmeans if you get significant anything other than a main effect
emmeans(rtkpin_glmm1, pairwise ~ Shoreline_End|Pin_Location|Log_Presence)


sim_res <- simulateResiduals(rtkpin_glmm1) # generates fitted model residuals
