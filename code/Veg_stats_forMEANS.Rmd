...
shapiro.test(TotalVeg_change$count_difference) #p > 0.05, accept null that samples come from a normal distribution. Normal when using count_difference but not if you use Total_Veg2.
