...
SaPa_change_box3 <- SaPa_change_box3 +
  geom_signif(comparisons = list(c("U", "L"), c("M","L")), map_signif_level = TRUE, annotations = "***", 
              ...
              color = "black",
              y_position = c(
                max(SaPa_change2$count_difference) + 10,  #adds space above the highest y-value for count_difference
                max(SaPa_change2$count_difference) + 5), #this moves the asterisks up/down relative to the significance line
              tip_length = 0.1, # Adjust tip length to control the length of the line from the bars
