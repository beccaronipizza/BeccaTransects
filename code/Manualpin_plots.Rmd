...
```{r}
sedpinchangecombo <- SedPinDataMerged[SedPinDataMerged$Log_Presence != "reference",] %>% 
...
```{r}
cbp2 <- c("#E69F00", "#56B4E9", "#0072B2", "#CC79A7", "#D55E00", "#009E73", "#56B4E9", "#F0E442" , "#E69F00", "#000000")


sedpincomboplot <- ggplot(sedpinchangecombo, aes(x= Pin_Location, y= mean_difference, 
                                                           group = Log_Presence,
                                                           fill= Log_Presence,
