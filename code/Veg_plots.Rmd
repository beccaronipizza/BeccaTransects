...
vegdata <- read_xlsx("~/GitHub/BeccaTransects/data/VegData_raw.xlsx", sheet = "Data_2") #Reference xs removed. For log zone removal use sheet = "Data2_LZ" <- make sure that right name
```
