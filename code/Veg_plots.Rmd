...
vegdata <- read_xlsx("~/GitHub/BeccaTransects/data/VegData_raw.xlsx", sheet = "Data_2_new") #Reference xs removed. For log zone removal use sheet = "Data2_LZ" <- make sure that right name
```
...
```{r}
TotalVeg_change <- vegdatamerged[(vegdatamerged$Log_Presence != "reference"),] %>% #filtering out reference transects
...
```{r}
TotalVeg_change_barplot2 <- ggplot(TotalVeg_change, 
                        mapping = aes(x = Zone,
                                y = mean_cover,
                                group = Shoreline_End,
                                fill = Shoreline_End)) +
  ...
  scale_x_discrete(labels = c(U = "Upper", M = "Middle", L = "Lower")) +
  coord_cartesian(ylim = c(-4, 30)) + #sets the limit of the y-axis to show a more dramatic difference bw variables
  labs( 
    title = "Mean Percent Cover Change in Total Vegetation Cover",
    subtitle = "From August 2022 to August 2023",
    x = "Marsh Zone",
    y ="Mean Cover Change (%)",
    fill = "End of Shoreline",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-TotalVeg_change_barplot2") +
  theme_bw(base_size = 10) +
   ...
   #             vjust = -.5,  #higher values shift text down                
    #            #hjust = 0.5, #higher values shift text horizontally left
     #           position = position_dodge(0.85),
      #          color = "black",
       #     size = 3.25) +
  geom_label(aes(label = mean_cover, y = -5),  # Adjust the x-coordinate
           vjust = -0.5,
           color = "black",
           position = position_dodge(0.85),
           size = 3.25,
...
#Same as above but not broken into zone:
```{r}
TotalVeg_change3 <- vegdatamerged[(vegdatamerged$Log_Presence != "reference"),] %>% #filtering out reference transects
  filter(Date == "2022-August" | Date == "2023-August") %>%
  group_by(Transect_ID, Quadrat) %>% 
  arrange(Date) %>% #arrange by date so the calculations can be made below
  mutate(initial_count = first(Total_Veg),
...
```{r}
TotalVeg_change3_barplot <- ggplot(TotalVeg_change3, 
  ...
  labs( 
    ...
    fill = "Log Presence",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-TotalVeg_change3_barplot") +
  theme_bw(base_size = 10) +
  theme(axis.title = element_text(face = "bold", size=13),
        legend.title = element_text(face = "bold", size=09),
        legend.text=element_text(size=09),
...
TotalVeg_change3_barplot
```

```{r}
TotalVeg_change3_barplot2 <- ggplot(TotalVeg_change3, 
  ...
  labs( 
    ...
    fill = "End of Shoreline",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-TotalVeg_change3_barplot2") +
  theme_bw(base_size = 10) +
  theme(axis.title = element_text(face = "bold", size=13),
        legend.title = element_text(face = "bold", size=09),
        legend.text=element_text(size=09),
...
TotalVeg_change_barplot2 <- ggplot(TotalVeg_change2, 
  ...
  scale_fill_manual(values = cbp) +
  scale_x_discrete(labels = c(U = "Upper", M = "Middle", L = "Lower")) +
  coord_cartesian(ylim = c(-4, 40)) + #sets the limit of the y-axis to show a more dramatic difference bw variables
  labs( 
    title = "Mean % Change in Total Vegetation Cover",
    subtitle = "From August 2022 to August 2023",
    x = "Marsh Zone",
  ...
  theme(axis.title = element_text(face = "bold", size=14),
        ...
        plot.tag.position = "right",
        strip.text = element_text(size = 13, color = "black")) +
  geom_label(aes(label = mean_cover, y = -05),  # Adjust the x-coordinate
           vjust = -0.5,
           color = "black",
           position = position_dodge(0.85),
           size = 3.25,
...
```{r}
TotalVeg_change_barplotEvW <- ggplot(TotalVeg_changeEvW, 
                                mapping = aes(x = Shoreline_End,
                                y = mean_cover,
                                fill = Shoreline_End,
                                group = Shoreline_End)) +
  ...
  labs( 
    ...
    fill = "Shoreline End",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-TotalVeg_change_barplotEvW") +
  theme_bw(base_size = 10) +
  theme(axis.title = element_text(face = "bold", size=14),
...
SaPa_change_barplot <- ggplot(SaPa_change, 
  ...
  labs( 
    title = expression(paste(bold("Mean Percent Cover Change in " *italic("Salicornia pacifica")* " Cover"))),
    subtitle = "From August 2022 to August 2023",
    x = "Marsh Zone",
    y ="Mean Cover Change (%)",
    fill = "Log Presence",
...
```{r}
SaPa_change_barplot2 <- ggplot(SaPa_change, 
                        mapping = aes(x = Zone,
                                y = mean_cover,
                                group = Shoreline_End,
                                fill = Shoreline_End)) +
  ...
  labs( 
    ...
    fill = "End of Shoreline",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-SaPa_change_barplot2") +
  theme_bw(base_size = 10) +
  theme(axis.title = element_text(face = "bold", size=13),
        legend.title = element_text(face = "bold", size=09),
        legend.text=element_text(size=09),
...
SpFo_change_barplot <- ggplot(SpFo_change, 
  ...
  labs( 
    title = expression(paste(bold("Mean Percent Cover Change in " *italic("Spartina foliosa")* " Cover"))),
    subtitle = "From August 2022 to August 2023",
    x = "Marsh Zone",
    y ="Mean Cover Change
    (%)",
...
```{r}
SpFo_change_barplot2 <- ggplot(SpFo_change, 
                        mapping = aes(x = Zone,
                                y = mean_cover,
                                group = Shoreline_End,
                                fill = Shoreline_End)) +
  ...
  labs( 
    ...
    fill = "End of Shoreline",
    caption = "*Error bars reflect standard error",
    tag = "Veg_plots.Rmd-SpFo_change_barplot2") +
  theme_bw(base_size = 10) +
  theme(axis.title = element_text(face = "bold", size=13),
        legend.title = element_text(face = "bold", size=09),
        legend.text=element_text(size=09),
...
#Now to wrap them all into one: #need to work on!!
```{r}
figure <- ggarrange(TotalVeg_change_barplot, SaPa_change_barplot, SpFo_change_barplot,
                    ncol = 1)
