...
#Sq meters:
```{r}
GISvegplot_byZ_sm <- ggplot(GISveg_byZ, 
                     mapping = aes(x = Date,
                                   y = Sq_meters,
                                   group = Zone,
                                   color = Zone,
  ...
  labs( 
    ...
    x = "Date of Survey",
    y ="Square Meters",
    tag = "Veg_plots_GIS.Rmd-GISvegplot_byZ_sm") +
    #caption = "*Error bars reflect standard error",
  theme_bw(base_size = 10) +
...
#Hectares:
```{r}
GISvegplot_byZ_h <- ggplot(GISveg_byZ, 
                     mapping = aes(x = Date,
                                   y = Hectares,
                                   group = Zone,
                                   color = Zone,
  ...
  labs( 
    ...
    x = "Date of Survey",
    y ="Hectares",
    tag = "Veg_plots_GIS.Rmd-GISvegplot_byZ_h") +
    #caption = "*Error bars reflect standard error",
  theme_bw(base_size = 10) +
  guides(shape = FALSE) + #turns off legend for shape
  theme(axis.title = element_text(face = "bold", size=12),
...
# *Sq meters: Barplot faceted with Shoreline end and year, broken up by zone: 
```{r}
...
```{r}
GISvegplot_byZandS_h <- ggplot(GISveg_byZandS, 
                     mapping = aes(x = Zone,
                                   y = Hectares,
                                   color = Zone,
                                   fill = Zone)) +
  ...
  labs( 
    ...
    #caption = "*Error bars reflect standard error",
    fill = "Shoreline End",
    tag = "Veg_plots_GIS.Rmd-GISvegplot_byZandS_h") +
  theme_bw(base_size = 10) +
  guides(fill = FALSE) + #turns off legend for fill
  theme(axis.title = element_text(face = "bold", size=12),
        legend.title = element_text(face = "bold", size=12),
